  ...
  @endif
    ...
    <div class="form-group row hide" id="existingDiv">
      ...
      <div class="col-sm-3 ui-widget">
        <input type="text" id="search_user" name="user_id" class="form-control" placeholder="enter user id" autocomplete="off">
      </div>
    </div>
   <form action="{{url('admin/update-admission-receipt')}}" method="POST" id="submitForm">
    {{ csrf_field() }}
    {{method_field('PUT')}}
    <div class="form-group row">
      ...
      <div class="col-sm-3">
          <input type="text" id="payment_date" class="form-control" name="payment_date" value="{{ date('d-m-Y',strtotime($coursePayment->payment_date)) }}" placeholder="DD-MM-YYYY">
      </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row @if ($errors->has('phone')) has-error @endif">
      ...
      <div class="col-sm-3">
          <input type="text" class="form-control" name="phone" id="phone" value="{{$coursePayment->phone}}" pattern="[0-9]{10}" placeholder="Enter 10 digits mobile number"  required="true" readonly>
    ...
    <div id="gstDiv">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-3">
          <input type="checkbox" name="fee_type" id="fee_type" @if(1 == $coursePayment->fee_type) checked="true" @endif onChange="toggleFeeType(this);">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-2">
        <label><input type="radio" name="fee_method" value="1" @if(empty($coursePayment->cheque_no)) checked="true" @endif onChange="togglePaymentMethod(this);"> Cash </label>
      </div>
      <div class="col-sm-2">
        <label><input type="radio" name="fee_method" value="0" @if(!empty($coursePayment->cheque_no)) checked="true" @endif onChange="togglePaymentMethod(this);"> Cheque </label>
      </div>
    </div>
    ...
    <div class="form-group row @if ($errors->has('payment_type')) has-error @endif">
      ...
      <div class="col-sm-2">
        <label><input type="radio" name="payment_type" value="1" @if(1 == $coursePayment->payment_type) checked="true" @endif onChange="toggleRemainderDate(this);"> Full Payment</label>
      </div>
      <div class="col-sm-2">
        <label><input type="radio" name="payment_type" value="0" @if(0 == $coursePayment->payment_type) checked="true" @endif onChange="toggleRemainderDate(this);"> Partial Payment</label>
      </div>
    ...
    <div class="form-group row @if ($errors->has('amount')) has-error @endif">
      ...
      <div class="col-sm-3">
          <input type="text" class="form-control" id="amount" name="amount" value="{{$coursePayment->amount}}" placeholder="Amount" required>
        @if($errors->has('amount')) <p class="help-block">{{ $errors->first('amount') }}</p> @endif
      </div>
      <div class="col-sm-6">
          <textarea class="form-control" name="comment" placeholder="enter comment">{{$coursePayment->comment}}</textarea>
      </div>
    </div>
    <div id="remainderDiv" class="form-group row hide">
      <label for="remainder_date" class="col-sm-2 col-form-label">Remainder Date:</label>
      <div class="col-sm-3">
          <input type="text" id="remainder_date" class="form-control" name="remainder_date" value="{{$coursePayment->remainder_date}}" placeholder="DD-MM-YYYY">
      </div>
    </div>
    @if(1 == $coursePayment->course_id)
      <div id="singleReceipt" class="hide">
    @else
    ...
    @endif
      <div class="form-group row @if ($errors->has('receipt_by')) has-error @endif">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control" id="receipt_by" name="receipt_by" value="{{$batch->receipt_by}}" placeholder="Receipt By Name" readonly>
    ...
    @endif
      ...
      <div class="form-group row ">
        ...
        <div class="col-sm-3">
          <input type="text" class="form-control" id="ram_rathi" name="ram_rathi" value="{{$coursePayment->ram_rathi}}" placeholder="Amount">
        </div>
        <div class="col-sm-6">
      ...
      <div class="form-group row ">
        ...
        <div class="col-sm-3">
          <input type="text" class="form-control" id="shyam_rathi" name="shyam_rathi" value="{{$coursePayment->shyam_rathi}}" placeholder="Amount">
        </div>
        <div class="col-sm-6">
      ...
      <div class="form-group row ">
        ...
        <div class="col-sm-3">
          <input type="text" class="form-control" id="giridhar_rathi" name="giridhar_rathi" value="{{$coursePayment->giridhar_rathi}}" placeholder="Amount">
        </div>
        <div class="col-sm-6">
      ...
      <div class="form-group row ">
        ...
        <div class="col-sm-3">
          <input type="text" class="form-control" id="dipti_rathi" name="dipti_rathi" value="{{$coursePayment->dipti_rathi}}" placeholder="Amount">
        </div>
        <div class="col-sm-6">
      ...
      <div class="form-group row ">
        ...
        <div class="col-sm-3">
          <input type="text" class="form-control" id="sunita_rathi" name="sunita_rathi" value="{{$coursePayment->sunita_rathi}}" placeholder="Amount">
        </div>
        <div class="col-sm-6">
    ...
    <input type="hidden" id="course_payment_id" name="course_payment_id" value="{{$coursePayment->id}}">
    <div class="form-group row">
...
<script type="text/javascript">
  ...
  function checkPayments(ele){
    ...
    if(feeStr){
      ...
      totalAmt = totalAmt + parseInt(feeStr);
    }
    if(gstStr){
      $('#gst').val(parseInt(gstStr));
      totalAmt = totalAmt + parseInt(gstStr);
    }
    ...
    var paymentId = $('#course_payment_id').val();
    if(courseId > 0 && subCourseId > 0 && batchId > 0){
      $.ajax({
        method:'POST',
        url: "{{url('admin/get-user-payments-by-courseId-by-subcourseId-by-batchId')}}",
        data:{course_id:courseId,subcourse_id:subCourseId,batch_id:batchId,user_id:userId,admission_type:admissionType,payment_id:paymentId}
  ...
  function searchExistingUser(){
    var userId = document.getElementById('search_user').value;
    if(userId.length > 0){
      $.ajax({
          method: "POST",
          url: "{{url('admin/get-user-by-user-id')}}",
      ...
      .done(function( user ) {
        if(user){
          ...
          $.alert({
             title: 'Alert!',
              content: 'No record for given user id.',
          });
          document.getElementById('f_name').value = '';
          document.getElementById('m_name').value = '';
          document.getElementById('l_name').value = '';
